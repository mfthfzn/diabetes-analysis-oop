...
class BaseAnalyzer(ABC):
    ...
    def records(self) -> list:
        """Getter untuk memberikan akses aman ke data records bagi subclasses."""
        return self.__records

    @records.setter
    def records(self, value: list):
        """Setter dengan validasi tipe data list."""
        if not isinstance(value, list):
            raise TypeError("Records harus berupa list (kumpulan objek PatientRecord).")
